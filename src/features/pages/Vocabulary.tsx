    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
        ...
        <div className="text-center md:text-left">
          <h1 className="text-2xl lg:text-3xl font-black text-gray-900 mb-1">Verbos más Usados</h1>
          <p className="text-base text-gray-600">Los 120 verbos más comunes en inglés con sus tres formas</p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-purple-500 bg-white transition-colors"
          >
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-2xl border border-blue-200 mb-6 shadow-md">
        <p className="text-sm text-gray-700">
          <strong>💡 Tip:</strong> Los verbos <span className="text-blue-600 font-semibold">irregulares</span> cambian su forma en pasado y participio. Los{" "}
          <span className="text-purple-600 font-semibold">regulares</span> añaden "-ed" en pasado y participio.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {currentVerbs.map((verb) => (
          <div
            key={verb.id}
            className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl p-5 transition-all duration-300 hover:scale-105 hover:-translate-y-1 overflow-hidden"
          >
            {/* Gradient overlay */}
            <div
              className={`absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-5 transition-opacity ${
                verb.category === "Irregular" ? "from-blue-500 to-cyan-500" : "from-purple-500 to-pink-500"
              }`}
            ></div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="relative">
                  <div
                    className={`absolute inset-0 rounded-full blur-md opacity-30 ${verb.category === "Irregular" ? "bg-blue-500" : "bg-purple-500"}`}
                  ></div>
                  <span
                    className={`relative text-xs px-3 py-1.5 rounded-full font-black shadow-lg ${
                ...
                <span className="text-sm font-bold text-gray-700 bg-gray-100 px-3 py-1.5 rounded-full shadow-sm">{verb.spanish}</span>
              </div>
              ...
              <div className="space-y-3 mb-4">
                <div className="relative bg-gradient-to-br from-gray-50 to-white rounded-2xl p-3 shadow-md border border-gray-100">
                  ...
                  <div className="text-xl font-black text-gray-900">{verb.present}</div>
                </div>
                ...
                <div className="relative bg-gradient-to-br from-blue-50 to-white rounded-2xl p-3 shadow-md border border-blue-100">
                  ...
                  <div className="text-xl font-black text-blue-700">{verb.past}</div>
                </div>
                ...
                <div className="relative bg-gradient-to-br from-purple-50 to-white rounded-2xl p-3 shadow-md border border-purple-100">
                  ...
                  <div className="text-xl font-black text-purple-700">{verb.participle}</div>
                </div>
              </div>
              ...
              <div className="relative bg-gradient-to-br from-gray-50 to-white backdrop-blur-sm p-3 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <div className="text-xs text-gray-700 leading-relaxed">{verb.example}</div>
              </div>
            </div>
          </div>
        ))}
      ...
      {filteredVerbs.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-500 text-lg">No se encontraron verbos que coincidan con tu búsqueda</p>
        </div>
      )}
